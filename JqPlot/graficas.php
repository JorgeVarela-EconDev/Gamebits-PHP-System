...
$(document).ready(function(){
  ...
  // Grafica de Torta
  var data = [
    ['God of War', 15],['Elden Ring', 11], ['GTA V', 12], 
    ['FIFA 20', 10],['Call of Duty', 9], ['Super Marios Bros', 7]
  ];
  var plot1 = jQuery.jqplot ('torta', [data], 
    { 
      title: {
              text: 'Estadisticas de Juegos elegidos',   // title for the plot,
              show: true,
      },
      seriesDefaults: {
  ...
  // Grafica de Barras  
        ...
        plot2 = $.jqplot('barras', [s1, s2], {
            title: {
              text: 'Estadisticas de Consola favorita',   // titulo
              show: true,
            },
            seriesDefaults:{ 
